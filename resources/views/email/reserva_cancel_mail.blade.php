...
<body>
	...
	<center>
		...
		<p>Este correo es para informarle que su reservación en el Restaurante M`ka para el dia {{ $reserva->getDiaFormat()}} a la hora {{ $reserva->getHoraFormat() }} fue cancelada por la siguiente razón.</p>
